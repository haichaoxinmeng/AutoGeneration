 ...
 * @Date:Created Administrator in 17:22 2017/12/21 0021
 * @Modified By:
 */
...
//        FullyQualifiedJavaType imp = new FullyQualifiedJavaType("cn.roc.mag.util.BaseDao");
...
//        interfaze.getMethods().clear();
    ...
    public boolean sqlMapDocumentGenerated(Document document, IntrospectedTable introspectedTable) {
        ...
        update.addAttribute(new Attribute("id", "deleteLogicByPrimaryKey"));
        ...
        update.addElement(new TextElement("SET is_deleted = 1,"));
        update.addElement(new TextElement("    remark=concat(remark,';delMark;'),"));
        update.addElement(new TextElement("    sys_code=concat(concat(sys_code,'_del_'),"));
        update.addElement(new TextElement("    unix_timestamp(now())),"));
        update.addElement(new TextElement("    gmt_modified=now()"));
        ...
        //添加selectListSelective
        XmlElement select = new XmlElement("select");
        select.addAttribute(new Attribute("id", "selectListSelective"));
